...
repo_url="https://kaasops.github.io/vector-operator/helm"
repo_name="vector-operator/vector-operator"
...
function init(){
  ...
  mkdir -p manifests/
  wget -q -P manifests/ https://raw.githubusercontent.com/kaasops/vector-operator/v0.0.30/config/samples/observability_v1alpha1_vector.yaml

...
IFACE=${IFACE:-}
POD_CIDR=${POD_CIDR:-"100.64.0.0/10"}     # Do NOT overlap with NODE/SVC/JOIN CIDR
POD_GATEWAY=${POD_GATEWAY:-"100.64.0.1"}
SVC_CIDR=${SVC_CIDR:-"10.96.0.0/22"}      # Do NOT overlap with NODE/POD/JOIN CIDR
JOIN_CIDR=${JOIN_CIDR:-"20.65.0.0/16"}    # Do NOT overlap with NODE/POD/SVC CIDR

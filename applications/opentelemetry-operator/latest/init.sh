...
download_chart() {
    ...
    local HELM_CHART_NAME="opentelemetry-operator"
    ...
    echo "docker.io/otel/opentelemetry-collector-contrib:${APP_VERSION}" > ${IMAGES_DIR}/opentelemetry-collector-contrib-images.txt
}

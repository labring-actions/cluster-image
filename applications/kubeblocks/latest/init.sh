...
https://jihulab.com/api/v4/projects/85949/packages/helm/stable/charts/pgcluster-${VERSION#v}.tgz
...
bash for-range.sh
helm upgrade -i kubeblocks charts/kubeblocks-${VERSION#v}.tgz --set snapshot-controller.enabled=false,addonChartLocationBase=oci://zot.zot.svc.cluster.local:8443/helm-charts --insecure-skip-tls-verify  -n kb-system --create-namespace
EOF
